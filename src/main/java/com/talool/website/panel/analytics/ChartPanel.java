...
public class ChartPanel extends Panel {
	...
	public ChartPanel(String id, String chartName, MetricListModel model)
	{
		super(id);
	...
	protected void onInitialize()
	{
		...
		WebMarkupContainer canvas = new WebMarkupContainer("chartCanvas");
		add(canvas);
		canvas.add(new ChartBehavior(model));
