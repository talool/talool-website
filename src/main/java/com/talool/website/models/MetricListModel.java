...
public class MetricListModel extends LoadableDetachableModel<List<Metric>>
{
	...
	public enum CHART_TYPE {CUSTOMERS, CUSTOMER_LOCATIONS, BOOKS, BOOKS_ACTIVATIONS, BOOK_PURCHASES, REDEMPTIONS, GIFTS};
	public enum METRIC_TYPE {
		...
		ACQUIRED_DEALS_TOTAL,  ACQUIRED_DEALS_GIFTS_SLICE, ACQUIRED_DEALS_GIFTS_FACEBOOK_SLICE, ACQUIRED_DEALS_GIFTS_EMAIL_SLICE, ACQUIRED_DEALS_REDEMPTIONS_SLICE
		};
