...
public class MerchantDealOfferPanel extends BaseDefinitionPanel
{
	...
	public MerchantDealOfferPanel(final String id, final Long merchantId, final Long merchantAccountId, final SubmitCallBack callback)
	{
	...
	public MerchantDealOfferPanel(final String id, final SubmitCallBack callback, final Long dealOfferId)
	{
